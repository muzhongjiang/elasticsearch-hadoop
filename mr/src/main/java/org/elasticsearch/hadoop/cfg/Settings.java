...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.DING_URL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_FLUSH_MANUAL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_FLUSH_MANUAL_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_SIZE_BYTES;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_SIZE_BYTES_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_SIZE_ENTRIES;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_SIZE_ENTRIES_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_REFRESH;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_REFRESH_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_COUNT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_COUNT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_POLICY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_POLICY_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_WAIT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_BATCH_WRITE_RETRY_WAIT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_DEFAULT_MAX_DOCS_PER_PARTITION;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HEART_BEAT_LEAD;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HEART_BEAT_LEAD_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HTTP_RETRIES;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HTTP_RETRIES_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HTTP_TIMEOUT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_HTTP_TIMEOUT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_AUTO_CREATE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_AUTO_CREATE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_READ_ALLOW_RED_STATUS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_READ_ALLOW_RED_STATUS_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_READ_MISSING_AS_EMPTY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INDEX_READ_MISSING_AS_EMPTY_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INGEST_PIPELINE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INGEST_PIPELINE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INPUT_JSON;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_INPUT_JSON_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_CONSTANT_AUTO_QUOTE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_CONSTANT_AUTO_QUOTE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_DATE_RICH_OBJECT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_DATE_RICH_OBJECT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_DEFAULT_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_DEFAULT_INDEX_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_DEFAULT_INDEX_FORMATTER_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_EXCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_EXCLUDE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_ID;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_ID_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_INCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_INCLUDE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_INDEX_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_INDEX_FORMATTER_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_PARAMS_DEFAULT_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_PARAMS_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_PARENT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_PARENT_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_ROUTING;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_ROUTING_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_TIMESTAMP;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_TIMESTAMP_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_TTL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_TTL_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_VERSION;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_VERSION_EXTRACTOR_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_VERSION_TYPE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_VERSION_TYPE_EXTERNAL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAPPING_VERSION_TYPE_INTERNAL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_MAX_DOCS_PER_PARTITION;
...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_HOST;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_PASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_PORT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_USER;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_USE_SYSTEM_PROPS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTPS_USE_SYSTEM_PROPS_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_HOST;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_PASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_PORT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_USER;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_USE_SYSTEM_PROPS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_HTTP_USE_SYSTEM_PROPS_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_HOST;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_PASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_PORT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_USER;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_USE_SYSTEM_PROPS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_PROXY_SOCKS_USE_SYSTEM_PROPS_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_CERT_ALLOW_SELF_SIGNED;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_CERT_ALLOW_SELF_SIGNED_DEFAULT;
...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_KEYSTORE_TYPE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_KEYSTORE_TYPE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_PROTOCOL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_SSL_PROTOCOL_DEFAULT;
...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_TRANSPORT_POOLING_EXPIRATION_TIMEOUT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_USE_SSL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NET_USE_SSL_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_CLIENT_ONLY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_CLIENT_ONLY_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_DATA_ONLY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_DEFAULT;
...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_INGEST_ONLY_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_PATH_PREFIX;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_PATH_PREFIX_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_RESOLVE_HOST_NAME;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_WAN_ONLY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_NODES_WAN_ONLY_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_OUTPUT_JSON;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_OUTPUT_JSON_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_PORT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_PORT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_QUERY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_AS_ARRAY_EXCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_AS_ARRAY_INCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_EMPTY_AS_NULL;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_EMPTY_AS_NULL_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_EMPTY_AS_NULL_LEGACY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_EXCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_INCLUDE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_VALIDATE_PRESENCE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_VALIDATE_PRESENCE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_FIELD_VALIDATE_PRESENCE_LEGACY;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA_FIELD;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA_FIELD_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA_VERSION;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_METADATA_VERSION_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_SOURCE_FILTER;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_UNMAPPED_FIELDS_IGNORE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_READ_UNMAPPED_FIELDS_IGNORE_DEFAULT;
...
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_KEEPALIVE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_KEEPALIVE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_LIMIT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_LIMIT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_SIZE;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SCROLL_SIZE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SERIALIZATION_READER_VALUE_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SERIALIZATION_WRITER_BYTES_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SERIALIZATION_WRITER_VALUE_CLASS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SPARK_DATAFRAME_WRITE_NULL_VALUES;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_SPARK_DATAFRAME_WRITE_NULL_VALUES_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_RETRY_ON_CONFLICT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_RETRY_ON_CONFLICT_DEFAULT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_SCRIPT;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_SCRIPT_LANG;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_SCRIPT_PARAMS;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_UPDATE_SCRIPT_PARAMS_JSON;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_WRITE_OPERATION;
import static org.elasticsearch.hadoop.cfg.ConfigurationOptions.ES_WRITE_OPERATION_DEFAULT;
import static org.elasticsearch.hadoop.cfg.InternalConfigurationOptions.INTERNAL_ES_EXCLUDE_SOURCE;
import static org.elasticsearch.hadoop.cfg.InternalConfigurationOptions.INTERNAL_ES_EXCLUDE_SOURCE_DEFAULT;
import static org.elasticsearch.hadoop.cfg.InternalConfigurationOptions.INTERNAL_ES_TARGET_FIELDS;
import static org.elasticsearch.hadoop.cfg.InternalConfigurationOptions.INTERNAL_ES_VERSION;
...
public abstract class Settings {
    ...
    public String getDingUrl() {//钉钉
        return getProperty(DING_URL, "https://oapi.dingtalk.com/robot/send?access_token=b52220f0890948c38ec9b056f71df24022540b616c483eea5f3639af1ef689f4");
    }
